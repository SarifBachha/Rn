#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To Aaryan
...
\033[1;91m--> GITHUB :- https://github.com/SarifBachha/Rn

\033[1;92m--> FACEBOOK :- Aaryan Jha

\033[1;93m--> YOUTUBE :-  Love Guru
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Aaryan:Aarav
	    time.sleep(2)
            loop = 'false'
        else:
